...
description: Discover why Chase UR points are often considered the most valuable currency. Learn how to maximize Hyatt transfers and navigate the 5/24 rule.
schemaType: Article
eyebrow: Valuations
breadcrumbs:
...
<p class="lead">Chase Ultimate Rewards (UR) is JPMorgan Chase's highly flexible credit card points program. Thanks to its remarkable stability and a uniquely powerful 1:1 transfer partnership with World of Hyatt, UR points are widely considered the gold standard of bank rewards.</p>
...
<p>The generally accepted baseline value for Chase Ultimate Rewards (UR) is around <strong>2.05¢ per point</strong>.</p>
...
<p>Some of the most popular and lucrative ways to use Chase Ultimate Rewards (UR) include:</p>
<p><em>Transferring 1:1 to World of Hyatt to book luxury resorts, or moving points to United MileagePlus for Star Alliance awards.</em></p>
...
<ul>
  ...
  <li><strong>Phantom Availability</strong>: Seeing an award seat doesn't guarantee you can book it. Chase enforce a strict 5/24 approval rule. While UR itself rarely devalues, the purchasing power of your points can decrease when partners (like United moving to dynamic pricing or Hyatt introducing peak pricing) devalue their own award charts.</li>
