...
description: Discover the true value of Air Canada Aeroplan points. Learn the best Star Alliance redemptions, stopover tricks, and common pitfalls to avoid.
schemaType: Article
eyebrow: Valuations
breadcrumbs:
  ...
  - name: Aeroplan
---
<h1>Air Canada Aeroplan Points Value & Strategy Guide</h1>
<p class="lead">Aeroplan is the frequent flyer program of Air Canada. As a key member of the Star Alliance, Aeroplan is renowned for its competitive award charts, generous stopover policies, and vast network of partner airlines, making it one of the most highly sought-after mileage currencies.</p>
...
<p>The generally accepted baseline value for Air Canada Aeroplan is around <strong>1.5¢ per point</strong>.</p>
...
<p>Some of the most popular and lucrative ways to use Air Canada Aeroplan include:</p>
<p><em>Booking transpacific Business Class on EVA Air or ANA, or flying short-haul domestic flights in North America on United Airlines.</em></p>
...
<ul>
  ...
  <li><strong>Phantom Availability</strong>: Seeing an award seat doesn't guarantee you can book it. Aeroplan uses a hybrid pricing model (dynamic for their own flights, fixed for partners). Additionally, users often encounter "phantom availability" and IT issues preventing ticketing.</li>
...
<ul>
  ...
  <li><strong>[Editorial] OMAAT Value Guide</strong>: <a href="https://onemileatatime.com/guides/value-frequent-flyer-miles/" target="_blank" rel="noopener">Baseline Value (1.5¢)</a> (Last checked: 2026-08-11)</li>
  <li><strong>[Official] Aeroplan Official Terms</strong>: <a href="https://www.aircanada.com/ca/en/aco/home/aeroplan.html" target="_blank" rel="noopener">Program Rules</a> (Last checked: 2026-08-11)</li>
</ul>
