...
<h2>什么是 Avios (英航 / 卡航 / 伊比利亚)？</h2>
<p>Avios 是一种由英国航空 (BA)、卡塔尔航空 (QR)、伊比利亚航空 (IB) 和芬兰航空 (AY) 共同使用的里程货币。它们可以在这几家航司的账户间以 1:1 的比例无损互转，常被称为“短途神器”。 本文将全面解析该常客计划的市场公允估值、常见兑换方式以及你需要警惕的潜在风险。</p>

<h2>当前市场参考估值 (CPP)</h2>
<div class="callout">
  <strong>核心声明：</strong> 常客计划的积分和里程不具备法定的固定价值。以下估值区间综合了英文媒体与常旅客圈的行业共识（美元原值按汇率 约 7.00 概算为人民币），仅供参考。
</div>
<p>在业界普遍共识中，Avios (英航 / 卡航 / 伊比利亚) 的基准估值约为 <strong>0.08 - 0.10 元/点</strong>。</p>
...
<h2>常见高价值兑换方式与示例</h2>
<p>Avios (英航 / 卡航 / 伊比利亚) 玩家公认的最佳用法通常包括：</p>
...
<ul>
  ...
  <li><strong>幽灵票与仓位限制</strong>：查到有票不等于能出票。Avios 的致命伤是极其高昂的燃油附加费 (YQ)。如果你用它兑换英航自家的长途长程商务舱，往往需要支付数千元的税费。</li>
...
<h2>官方规则与参考来源</h2>
<ul>
  <li><strong>官方网站</strong>：<a href="https://www.britishairways.com/en-us/executive-club" target="_blank" rel="noopener">Avios (英航 / 卡航 / 伊比利亚) 官方页面</a></li>
  <li><a href="https://thepointsguy.com/guide/monthly-valuations/" target="_blank" rel="noopener">TPG Avios Valuation (1.5 cents/pt)</a></li>\n  <li><a href="https://onemileatatime.com/guides/value-frequent-flyer-miles/" target="_blank" rel="noopener">OMAAT Avios Valuation (1.3 cents/pt)</a></li>
