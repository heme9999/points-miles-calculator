...
if (!pvc.includes('<div class="formula-box">')) {
  pvc = pvc.replace('<h2>The 5-Step Award vs. Cash Decision Framework</h2>', 
...
if (!ptd.includes('<div class="formula-box">')) {
  ptd = ptd.replace('<h2>Points to Dollars Conversion Rules</h2>',
...
<h2>Points to Dollars Conversion Rules</h2>`);
...
if (!tb.includes('<div class="formula-box">')) {
  tb = tb.replace('<h2>Transfer Bonus Calculation Scenarios</h2>',
...
<h2>Transfer Bonus Calculation Scenarios</h2>`);
